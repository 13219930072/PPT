...
| 5 | 什么风格？ | 科研满框大字三线表（专属定制/企业学术复刻版）/科技简约/正式商务/轻松活泼/高端大气 |
...
| **科研/学术满框大字定制** | **[academic-fullframe-style.md](references/academic-fullframe-style.md)** |
...
| 工作汇报 | workplace.md |
| 涉及数据表格 | charts.md |
| 涉及配色 | color-system.md / extended-themes.md |
| 涉及科研/企业攻关/三线表 | **academic-fullframe-style.md** |
...
| [academic-fullframe-style.md](references/academic-fullframe-style.md) | **学术满框大字三线表专属风格规范** |
